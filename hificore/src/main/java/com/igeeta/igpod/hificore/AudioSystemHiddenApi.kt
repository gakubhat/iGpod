...
package com.igeeta.igpod.hificore
...
object AudioSystemHiddenApi {
    ...
    private val adapterClazz by lazy {
        Class.forName("com.igeeta.igpod.audiosysfwd.AudioVolumeGroupCallbackAdapter")
    }
        ...
        try {
            if (Build.VERSION.SDK_INT >= 36) {
                val adapter = adapterClazz.getDeclaredConstructor(
                    com.igeeta.igpod.audiosysfwd.AudioVolumeGroupCallback::class.java
                ).apply { isAccessible = true }
                    .newInstance(com.igeeta.igpod.audiosysfwd.AudioVolumeGroupCallback {
