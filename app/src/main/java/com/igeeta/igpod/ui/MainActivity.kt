...
import com.igeeta.igpod.logic.gramophoneApplication
import com.igeeta.igpod.logic.hasAudioPermission
import com.igeeta.igpod.logic.hasScopedStorageV2
import com.igeeta.igpod.logic.hasScopedStorageWithMediaTypes
import com.igeeta.igpod.logic.needsMissingOnDestroyCallWorkarounds
import com.igeeta.igpod.logic.postAtFrontOfQueueAsync
import com.igeeta.igpod.logic.ui.BaseActivity
import com.igeeta.igpod.ui.adapters.PlaylistAdapter
import com.igeeta.igpod.ui.components.PlayerBottomSheet
import com.igeeta.igpod.ui.fragments.BaseFragment
import com.igeeta.igpod.ui.fragments.GeneralSubFragment
import com.igeeta.igpod.ui.fragments.SearchFragment
import com.igeeta.igpod.ui.fragments.ViewPagerFragment
...
class MainActivity : BaseActivity() {
    ...
    private fun doPlayFromIntent(intent: Intent) {
        ...
        val autoPlayId = intent.extras?.getString(PLAYBACK_AUTO_PLAY_ID) ?: (if
                (intent.action == "com.igeeta.igpod.action.PLAY_MEDIA_FROM_SUGGESTION")
                intent.data?.let {
                    try {
        ...
        if (intent.action == "com.igeeta.igpod.action.SHUFFLE") {
