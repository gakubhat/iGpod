 ...
 */
abstract class CallbackViewInflater(
    private val parent: AppCompatViewInflater,
    ...
    final override fun createImageButton(
        context: Context,
        attrs: AttributeSet
    ...
    final override fun createMultiAutoCompleteTextView(
        ...
        return createView(
            ...
            attrs
        ) as AppCompatMultiAutoCompleteTextView
    }

    final override fun createRadioButton(
        context: Context,
        attrs: AttributeSet
