 ...
 */
public class QuickLinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public QuickLinearSmoothScroller(Context context) {
    ...
    protected void updateActionForInterimTarget(Action action) {
        ...
        if (mTargetVector != null) {
            int currentPosition = ((LinearLayoutManager) getLayoutManager())
                    .findFirstVisibleItemPosition();
            if (getTargetPosition() - currentPosition > 20) {
                action.jumpTo(getTargetPosition() - 20);
                return;
            } else if (currentPosition - getTargetPosition() > 20) {
                action.jumpTo(getTargetPosition() + 20);
                return;
            }
        }
